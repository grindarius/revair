        ...
        <div class="grid grid-cols-2 gap-y-4 gap-x-6 py-4 mt-6 md:grid-cols-4">
            ...
            <div class="input-box">
              <div class="grid grid-cols-2">
                ...
                <button @click="openMarkdownRef('https://markdown-it.github.io/')" class="self-center place-self-end">
                  <v-mdi name="mdi-information-outline" fill="#B47EDE" class="self-center place-self-end" />
                </button>
              </div>
              <span
          ...
          <div class="col-span-4 md:col-span-2 input-box">
            ...
            <div class="flex flex-row items-center">
              ...
              <v-mdi name="mdi-plus-circle" class="mx-3 cursor-pointer" size="36" fill="#B47EDE" @click="addEventTime" />
            </div>
          </div>
          <div class="col-span-4">
            <div v-for="(time, i) in selectedTimes" :key="`selected-event-time-${i}`">
              <div class="add-list-remove">
                {{ getTimeString(time) }}
                <v-mdi name="mdi-minus-circle" class="mx-3 cursor-pointer" size="36" fill="#B47EDE" @click="removeEventTime(i)" />
              </div>
            </div>
          </div>
