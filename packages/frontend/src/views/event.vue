        ...
        <div class="grow">
          ...
          <div class="event-details">
            <div class="event-calendar">
              <v-mdi name="mdi-calendar-blank" size="60" fill="#B47EDE" />
            ...
            <div class="event-times">
              <v-mdi name="mdi-alarm" size="60" fill="#B47EDE" />
            ...
            <div class="event-prices">
              <v-mdi name="mdi-currency-usd" size="60" fill="#B47EDE" />
            ...
            <div class="cursor-pointer event-place" @click="openGoogle(eventData?.venueCoordinates ?? { x: '0', y: '0' })">
              <v-mdi name="mdi-map-marker-account" size="60" fill="#B47EDE" />
